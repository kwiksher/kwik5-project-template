...
local models         = require(kwikGlobal.RESOUCES.."template.commands.model").menu
...
local audioButtons       = require(kwikGlobal.ROOT.."editor.audio.buttons")
...
function M:showActionTable(actionbox, isNew)
  ...
  if isNew then
    ...
    elseif self.UI.editor.currentClass == "audio" then
      audioButtons:hide()
    else
      partsButtons:hide()
    end
