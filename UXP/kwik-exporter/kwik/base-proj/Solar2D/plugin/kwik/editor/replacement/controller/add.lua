...
local instance =
  ...
  function(params)
    ...
    if params.type =="line" then
      default = require(kwikGlobal.RESOUCES.."template.components.pageX.replacement.defaults.sync")
      entry = default.line[1]
    elseif (params.type == "sequenceData") then
      default = require(kwikGlobal.RESOUCES.."template.components.pageX.replacement.defaults.spritesheet")
