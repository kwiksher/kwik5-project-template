...
set src=./template/components/pageX/layer/bg.lua
set class=button
...
for %%p in (!pages!) do (
  ...
  powershell -Command "(Get-Content '!book_path!\components\!page!\layers\!layer!_!class!.lua') -replace 'emitter_gemini\.lua', '!page!.json' | Set-Content '!book_path!\components\!page!\layers\!layer!_!class!.lua'"

  echo local sceneName = ... > "!book_path!\components\!page!\index.lua"
  echo -- >> "!book_path!\components\!page!\index.lua"
  echo local scene = require('controller.scene').new(sceneName, { >> "!book_path!\components\!page!\index.lua"
  echo     components = { >> "!book_path!\components\!page!\index.lua"
  echo       layers = { { !layer! = { class= { "!class!" }} } }, >> "!book_path!\components\!page!\index.lua"
  echo       audios = { }, >> "!book_path!\components\!page!\index.lua"
  echo       groups = { }, >> "!book_path!\components\!page!\index.lua"
  echo       timers = { }, >> "!book_path!\components\!page!\index.lua"
  echo       variables = { }, >> "!book_path!\components\!page!\index.lua"
  echo       page = { } >> "!book_path!\components\!page!\index.lua"
  echo     }, >> "!book_path!\components\!page!\index.lua"
  echo     commands = { }, >> "!book_path!\components\!page!\index.lua"
  echo     onInit = function(scene) print("onInit") end >> "!book_path!\components\!page!\index.lua"
  echo }) >> "!book_path!\components\!page!\index.lua"
  echo -- >> "!book_path!\components\!page!\index.lua"
  echo return scene >> "!book_path!\components\!page!\index.lua"
)
