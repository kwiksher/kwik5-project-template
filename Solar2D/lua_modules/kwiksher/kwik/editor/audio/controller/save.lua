  ...
  function (params)
    ...
    for i=1, #properties do
      ...
      if name =="_type" then
        ...
        props.subclass =  t
        name = "type"
      elseif name== "_file" or name == "file" then
        name = "filename"
      end
    ...
    -- save lua
    files[#files+1] = controller:render(book, page, props.subclass, props.name, props)
    -- save json
    files[#files+1] = controller:save(book, page, props.subclass, props.name, props)
    -- publish
